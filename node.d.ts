...
declare namespace $ {
    class $hyoo_idea_domain extends $mol_object2 {
        ...
        persons(): $hyoo_idea_persons;
        person(id: $mol_int62_string): $hyoo_idea_person;
...
declare namespace $ {
    class $hyoo_idea_persons extends $hyoo_idea_entity {
        list_node(): $hyoo_crowd_list;
        add(obj: $hyoo_idea_person): void;
    ...
    class $hyoo_idea_person extends $hyoo_idea_entity {
        ...
        projects(next?: $hyoo_idea_project[]): $hyoo_idea_project[];
        project_add(obj: $hyoo_idea_project): void;
...
declare namespace $ {
    ...
    class $hyoo_idea_project extends $hyoo_idea_entity {
        ...
        stage(next?: $hyoo_idea_project_stages): $hyoo_idea_project_stages;
        roles_node(): $hyoo_crowd_list;
        roles(next?: Array<{
            name: string;
            functions: string;
            person: string;
...
declare namespace $ {
    class $hyoo_idea_project_form extends $mol_form {
        ...
        stage_options(): Record<string, any>;
        ...
        team_member_dict(): Record<string, any>;
...
declare namespace $.$$ {
    ...
    export class $hyoo_idea_person_form extends $.$hyoo_idea_person_form {
        ...
        company(id: number, next?: string): any;
        industry(id: number, next?: string): any;
        functions(id: number, next?: string): any;
        present(id: number, next?: boolean): any;
        ...
        specialty(id: number, next?: string): string;
        degree(id: number, next?: string): string;
        institution(id: number, next?: string): string;
        department(id: number, next?: string): string;
...
declare namespace $.$$ {
    const $hyoo_idea_person_form_multy: {
        margin: $mol_style_func<"var", "--mol_gap_block">;
        padding: {
            bottom: $mol_style_func<"var", "--mol_gap_block">;
        };
        border: {
            radius: $mol_style_func<"var", "--mol_gap_round">;
        };
        background: {
            color: $mol_style_func<"var", "--mol_theme_card">;
        };
        $mol_form_field: {
            padding: {
                left: $mol_style_func<"var", "--mol_gap_block">;
                right: $mol_style_func<"var", "--mol_gap_block">;
                top: $mol_style_func<"var", "--mol_gap_space">;
                bottom: $mol_style_func<"var", "--mol_gap_space">;
            };
        };
    };
}
...
declare namespace $.$$ {
    ...
    export class $hyoo_idea_project_form extends $.$hyoo_idea_project_form {
        ...
        team_member_dict(): Record<string, string>;
...
declare namespace $ {
    class $hyoo_idea_post_card extends $mol_list {
        ...
        Comment_author(id: any): $$.$hyoo_idea_person_card;
...
declare namespace $.$$ {
    class $hyoo_idea_project_page extends $.$hyoo_idea_project_page {
        ...
        Edit(): $mol_link;
        body(): readonly any[];
        main(): ($hyoo_idea_project_stage | $mol_link_iconed | $mol_text)[];
        slides(): string;
        slides_content(): string;
        slides_send(): void;
        join_request(): void;
...
declare namespace $ {
    class $hyoo_idea_person_page extends $mol_page {
        ...
        Job_company(id: any): $$.$mol_paragraph;
        job_dates(id: any): string;
        Job_dates(id: any): $$.$mol_paragraph;
        job_functions(id: any): string;
        Job_functions(id: any): $$.$mol_text;
        Job(id: any): $$.$mol_list;
        jobs(): readonly any[];
        Jobs_list(): $$.$mol_list;
        Jobs(): $$.$mol_section;
        ...
        Education_details(id: any): $$.$mol_paragraph;
...
declare namespace $.$$ {
    class $hyoo_idea_person_page extends $.$hyoo_idea_person_page {
        ...
        job_dates(id: number): string;
        job_functions(id: number): string;
        education(): $mol_list[];
...
declare namespace $.$$ {
    class $hyoo_idea_invite_page extends $.$hyoo_idea_invite_page {
        ...
        person(): $hyoo_idea_person;
        project(): $hyoo_idea_project;
        project_dict(): Record<string, string>;
        person_dict(): Record<string, string>;
